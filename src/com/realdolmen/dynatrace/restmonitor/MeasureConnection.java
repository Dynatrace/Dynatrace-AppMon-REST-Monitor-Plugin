...
/**
 * Class collects the result of one ResyMonitor execution and apply the measures to the MonitorEnvironment.
 *
 */
public class MeasureConnection {

	static final String METRIC_GROUP = "REST Monitor Connection";
	 ...
	 */
	MeasureConnection(MonitorEnvironment env) {
